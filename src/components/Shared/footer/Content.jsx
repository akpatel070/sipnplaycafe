    ...
    <>
      ...
      >
        <div>
          ...
          <p className={`flex ${isWide ? `text-[center] mt-3 ml-[320px] w-full` : `text-base mt-1`}`}>
             ©2024 developed by Agast Garsondiya & Hetul Vaghasiya
          </p>
        </div>
      </div>
    </>
...
const Nav = () => {
  ...
  const emailAddress = 'sipnplay@gmail.com';
